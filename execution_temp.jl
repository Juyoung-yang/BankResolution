...
# solve_model_given_r_single(0.01)
# solve_model_given_r_single(1.90)

@time solve_model(solve_model_given_r_single, params, false, 0.01, 1.9)
@time solve_model(solve_model_given_r_single, params, true, 0.01, 1.9)
...
params = Initiate_Params(qd,β,Rf,wr,α,ρ,g,ξ,cF,dBar,σ,τC,z,α1,α2,α3,δL,δM,δH,cM,cO,cL,ϵ,H,F,λL,λM,λH,γ,ϕ,n_start,n_npts,n_stop,l_start,l_npts,l_stop,s_start,s_npts,s_stop,b_start,b_npts,b_stop)
vFuncs = Initiate_vFunc(params)
vFuncsNew = Initiate_vFuncNew(params)
