...
# sigHat = 1.5;
# lconstr = 2.4; # loan-to-asset maximum constraint    

n_start = eps() # -10.0; # retained earning could be negative, in particular when bank doesn't fail and tax is too high 
n_npts = 5 # 11
n_stop = 100.0
l_start = eps()
l_npts = 5 # 20
